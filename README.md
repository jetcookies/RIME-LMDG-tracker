...
本仓库使用 [GitHub Actions](.github/workflows/ci.yml) 定时抓取 [amzxyz/RIME-LMDG/releases/tag/LTS](https://github.com/amzxyz/RIME-LMDG/releases/tag/LTS) 中 `wanxiang-lts-zh-hans.gram`，并发布在 [Releases](https://github.com/jetcookies/RIME-LMDG-tracker/releases)，供有需要的用户下载使用。
...
> [!TIP]
> 由于上游可能一日内更新多次，为避免 tag 碰撞，本仓库选择在上游停止变动次日进行发布。